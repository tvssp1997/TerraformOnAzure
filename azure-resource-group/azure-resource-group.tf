...
#   {
#   "appId": "0aa4ec9d-3f6c-4172-ab19-2a18a74d93a8",
#   "displayName": "azure-cli-2024-02-09-04-27-07",
#   "password": "yiW8Q~z6Oz50Kn3djENjDI28XThzr3IWFf5sdc4E",
# }
}


resource "azurerm_resource_group" "test12_rg" {
  name = "test12_rg"
  location = "East US"
}
